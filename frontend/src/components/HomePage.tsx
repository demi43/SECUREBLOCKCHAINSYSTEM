...
import { getUserSessionId, setUserSessionId } from '../ably';
            ...
            <CardContent className="p-4">
              ...
              {showSessionSync && (
                <div className="mt-4 pt-4 border-t border-slate-700/50 space-y-3">
                  ...
                  <div>
                    <Label className="text-xs text-gray-400 mb-2 block">Your Session ID (copy this to sync on another device):</Label>
                  ...
                  <div>
                    <Label className="text-xs text-gray-400 mb-2 block">Paste Session ID from another device:</Label>
                    <div className="flex items-center gap-2">
                      <Input
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      After syncing, the page will refresh automatically
                    </p>
                  </div>
                </div>
              )}
